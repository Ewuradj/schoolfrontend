...
import allSchools from "../../components/allSchools.json"

const EachSchoolsPage = () => {
  const params=useParams();
  const schoolId=params.schoolId

  const school = allSchools[0].schools.find(school => school.ID === schoolId);
  ...
  return (
    <div>
      <Navbar/>
    <div className="container bg-sky-50 mx-auto p-6">
    <motion.div
  ...
  <div className="flex flex-wrap">
    <div className="w-full lg:w-3/4 bg-white shadow-lg rounded-lg p-8">
      ...
      <div className="flex justify-between items-center mb-6">
        <div className="text-sm bg-blue-200 text-blue-800 py-1 px-3 rounded-full">
          {school.level}
        </div>
      ...
      <div className="grid grid-cols-4 gap-2 mb-6">
        ...
        <img src='https://www.schoolguide.co.uk/assets/infograph/schools_page/bust-140adf50ac005fcc19ad68584c6400424951e0f09fe8be226ef3d93fb4d3a713.png' alt="School" className="w-200 h-auto bg-yellow-400 " />
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M11.48 3.499a.562.562 0 0 1 1.04 0l2.125 5.111a.563.563 0 0 0 .475.345l5.518.442c.499.04.701.663.321.988l-4.204 3.602a.563.563 0 0 0-.182.557l1.285 5.385a.562.562 0 0 1-.84.61l-4.725-2.885a.562.562 0 0 0-.586 0L6.982 20.54a.562.562 0 0 1-.84-.61l1.285-5.386a.562.562 0 0 0-.182-.557l-4.204-3.602a.562.562 0 0 1 .321-.988l5.518-.442a.563.563 0 0 0 .475-.345L11.48 3.5Z" />
        ...
        <div className="text-sm">
          <div className="mb-2">
            <img src="https://icons8.com/icon/13800/location" alt="Location" /> {school.location}
          </div>
          <div className="mb-2">
          ...
          <div>
          <Link to='/ {school_website}'><h2 className="text-lg font-bold">Website: </h2></Link>
          </div>
          {/* <div className="mb-2">
      ...
      <Link to='/review'>
      <div className="bg-purple-500 text-white p-4 rounded-lg shadow-lg sticky top-20 mt-4 cursor-pointer">
  ...
  export default EachSchoolsPage;
