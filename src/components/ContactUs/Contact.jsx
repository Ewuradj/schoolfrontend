...
const Contact = () => {
  return (
    <div>
        ...
        <div className="max-w-screen-lg mx-auto p-5 bg-blue-50">
  <div className="grid grid-cols-1 md:grid-cols-12 border overflow-hidden">
    <div className="bg-gray-900 md:col-span-4 p-10 text-white">
      ...
      SchoolConnect has a dedicated team ready to assist you with any inquiries you may have. Get in touch with us today and experience our responsive service.
      </p>
      ...
      <div className="flex items-center mt-5">
        ...
        <span className="text-sm">+233 2090 62712</span>
      </div>
      <div className="flex items-center mt-5">
        <svg
          className="h-6 mr-2 text-indigo-600"
